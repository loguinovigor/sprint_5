...
from src.helpers import get_test_user
...
class TestLogin:
    def test_succesfull_login(self, driver: WebDriver, main_page):
        ...
        # используем тестового пользователя, а не регистраем нового
        email, password = get_test_user()
